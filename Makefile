.PHONY: install install-dev run run-prod lint format test test-cov test-unit test-integration docker-build docker-up docker-down docker-logs ingest evaluate benchmark clean db-init db-migrate db-upgrade help
...
help:
	...
	@echo "  make ingest       - Run document ingestion CLI"
	@echo "  make benchmark    - Run RAG performance benchmarking"
